...
public class Starter {
    ...
    public static String getTreeInfo(Branch branch){
        List<Corp> subordinateInfo = branch.getSubordinateInfo();
        StringBuilder builder = new StringBuilder();
        builder.append(branch.getInfo()).append('\n');
        for (Corp iCorp : subordinateInfo) {
            if (iCorp instanceof Branch){
                builder.append(getTreeInfo((Branch) iCorp));
            }else {
                builder.append(iCorp.getInfo()).append("\n");
            }
        }
